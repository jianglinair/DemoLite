...
public class SuccessView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (leftValue > 0) {
            canvas.drawLine(mCenterX - mRadius / 2, mCenterY, mCenterX - mRadius / 2 + leftValue, mCenterY + leftValue, mLinePaint);
        }
        if (rightValue > 0) {
            canvas.drawLine(mCenterX, mCenterY + mRadius / 2, mCenterX + rightValue, mCenterY + mRadius / 2 - 1.5f * rightValue, mLinePaint);
        }
    }
    ...
    private void initAnimator() {
        ...
        ObjectAnimator leftAnimator = ObjectAnimator.ofFloat(this, "leftValue", 0, mRadius / 2);
        leftAnimator.setDuration(200);
        ObjectAnimator rightAnimator = ObjectAnimator.ofFloat(this, "rightValue", 0, mRadius / 2);
