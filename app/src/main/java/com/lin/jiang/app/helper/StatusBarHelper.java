 ...
 * Date: 2019/01/11 18:12<br>
 * Description: StatusBarHelper <br>
...
public class StatusBarHelper {
    ...
    /*=========================================================================
     * 这几个 translucent() 方法都会透明化状态栏并使 content 延伸至状态栏区域
     *========================================================================*/
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (isMIUICustomStatusBarLightModeImpl() && setMIUIStatusBarLightMode(activity.getWindow(), true)) {
                ...
                setAndroid6StatusBarLightMode(activity.getWindow(), true);
    ...
    private static boolean setStatusBarLightMode(Activity activity, @StatusBarType int type) {
        if (type == STATUSBAR_TYPE_MIUI) {
            ...
            return setAndroid6StatusBarLightMode(activity.getWindow(), true);
        }
        return false;
    }
    ...
    public static boolean setStatusBarDarkMode(Activity activity) {
        ...
        if (mStatuBarType == STATUSBAR_TYPE_MIUI) {
            ...
            return setAndroid6StatusBarLightMode(activity.getWindow(), false);
        }
        return true;
    }
     ...
     */
    @TargetApi(23)
    private static boolean setAndroid6StatusBarLightMode(Window window, boolean light) {
        View decorView = window.getDecorView();
    ...
    public static boolean setMIUIStatusBarLightMode(Window window, boolean light) {
    ...
    public static boolean FlymeSetStatusBarLightMode(Window window, boolean light) {
        ...
        if (window != null) {
            ...
            setAndroid6StatusBarLightMode(window, light);
